...
import { fetchAutoAdjusters } from '@/lib/database';
...
export default function DefendantFormSection({
    ...
    const getLiabilityStatus = () => {
        if (totalLiability > 100) {
            ...
            return { color: 'text-yellow-600 dark:text-yellow-400', bg: 'bg-yellow-50 dark:bg-yellow-900/10', border: 'border-yellow-200 dark:border-yellow-800' };
        } else {
            return { color: 'text-green-600 dark:text-green-400', bg: 'bg-green-50 dark:bg-green-900/10', border: 'border-green-200 dark:border-green-800' };
        }
    };
            ...
            {isExpanded && (
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <h4 className="text-md font-medium text-foreground border-b border-border pb-2">Defendant Information</h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-destructive ${errors[`defendants.${index}.firstName`] ? 'border-destructive' : 'border-input'
                                        }`}
                                    placeholder="First name"
                                />
                                {errors[`defendants.${index}.firstName`] && (
                                    <p className="mt-1 text-sm text-destructive">{errors[`defendants.${index}.firstName`]}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-destructive ${errors[`defendants.${index}.lastName`] ? 'border-destructive' : 'border-input'
                                        }`}
                                    placeholder="Last name"
                                />
                                {errors[`defendants.${index}.lastName`] && (
                                    <p className="mt-1 text-sm text-destructive">{errors[`defendants.${index}.lastName`]}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-3 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-destructive ${errors[`defendants.${index}.liabilityPercentage`] ? 'border-destructive' : 'border-input'
                                            }`}
                                        placeholder="100"
                                    />
                                ...
                                {errors[`defendants.${index}.liabilityPercentage`] && (
                                    <p className="mt-1 text-sm text-destructive">{errors[`defendants.${index}.liabilityPercentage`]}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="border-t border-border pt-4">
                            <h4 className="text-sm font-medium text-foreground mb-3">Relationship to Other Defendants</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2 bg-background border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-destructive"
                                    >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2 bg-background border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-destructive disabled:bg-muted disabled:text-muted-foreground"
                                    >
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-2">
                                <input
                                    ...
                                    className="w-4 h-4 text-destructive border-input rounded focus:ring-2 focus:ring-destructive"
                                />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex gap-2">
                                <div className="flex-1">
                                    ...
                                    <select
                                        ...
                                        className={`w-full px-3 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-destructive ${errors[`defendants.${index}.autoInsuranceId`] ? 'border-destructive' : 'border-input'
                                            }`}
                                    >
                                    ...
                                    {errors[`defendants.${index}.autoInsuranceId`] && (
                                        <p className="mt-1 text-sm text-destructive">{errors[`defendants.${index}.autoInsuranceId`]}</p>
                                    )}
                                </div>
                                <button
                                    type="button"
                                    onClick={() => setShowAutoInsuranceModal(true)}
                                    className="mt-6 px-3 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 text-sm font-medium"
                                    ...
                                    onSave={async (name, savePermanently, phone, city, state) => {
                                        if (savePermanently) {
                                            try {
                                                ...
                                                const { createAutoInsurer } = await import('@/lib/database');
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-destructive ${errors[`defendants.${index}.policyNumber`] ? 'border-destructive' : 'border-input'
                                        }`}
                                    placeholder="Policy number"
                                />
                                {errors[`defendants.${index}.policyNumber`] && (
                                    <p className="mt-1 text-sm text-destructive">{errors[`defendants.${index}.policyNumber`]}</p>
                                )}
                            </div>
                        </div>
                        <div>
                        ...
                        {defendant.autoInsuranceId && typeof defendant.autoInsuranceId === 'number' && defendant.autoInsuranceId > 0 && (
                            <div className="border-t border-border pt-4 mt-4">
                                <div className="flex items-center justify-between mb-3">
                                    <h5 className="text-sm font-semibold text-muted-foreground">Auto Insurance Adjuster</h5>
                                    <button
                                        type="button"
                                ...
                                {loadingAdjusters && (
                                    <p className="text-xs text-muted-foreground">Loading adjusters...</p>
                                )}
                            </div>
                        )}
                            ...
                            {defendant.autoAdjusterId ? (
                                ...
                                (() => {
                                    ...
                                    return selectedAdjuster ? (
                                        <div className="mt-2 p-3 bg-green-50/50 border border-green-200/50 rounded-md dark:bg-green-900/10 dark:border-green-800">
                                            ...
                                            {selectedAdjuster.email && (
                                                <p className="text-sm text-muted-foreground mt-1">Email: {selectedAdjuster.email}</p>
                                            )}
                                            {selectedAdjuster.phone && (
                                                <p className="text-sm text-muted-foreground mt-1">Phone: {selectedAdjuster.phone}</p>
                                            )}
                                            {selectedAdjuster.fax && (
                                                <p className="text-sm text-muted-foreground mt-1">Fax: {selectedAdjuster.fax}</p>
                                            )}
                                            <button
                                                type="button"
                                ...
                                <div className="mt-2 p-3 bg-green-50/50 border border-green-200/50 rounded-md dark:bg-green-900/10 dark:border-green-800">
                                    ...
                                    {defendant.adjusterEmail && (
                                        <p className="text-sm text-muted-foreground mt-1">Email: {defendant.adjusterEmail}</p>
                                    )}
                                    {defendant.adjusterPhone && (
                                        <p className="text-sm text-muted-foreground mt-1">Phone: {defendant.adjusterPhone}</p>
                                    )}
                                    <button
                                        type="button"
                                        onClick={() => {

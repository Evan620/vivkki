...
import { createAutoAdjuster, createHealthAdjuster } from '@/lib/database';
                ...
                {!showCreateForm ? (
                    <>
                        <div>
                            ...
                            {isLoading ? (
                                ...
                                <div className="text-center py-4">
                                    <p className="text-sm text-muted-foreground mb-2">No adjusters found for this insurance.</p>
                                    <p className="text-xs text-muted-foreground">Click "Add New Adjuster" to create one.</p>
                                </div>
                            ) : (
                                <>
                                    <FormSelect
                        ...
                        <button
                            ...
                            className="w-full px-4 py-2 border-2 border-primary text-primary rounded-md hover:bg-primary/5 transition-colors flex items-center justify-center gap-2"
                        >
                    ...
                    <>
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-foreground">New Adjuster Information</h3>
                            <button
                                type="button"

...
import { fetchHealthInsurers, fetchAutoInsurers, fetchHealthAdjusters, fetchAutoAdjusters } from '../../utils/database';
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.firstName`] ? 'border-red-500' : 'border-gray-300'
                }`}
                placeholder="First name"
              />
              {errors[`clients.${index}.firstName`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.firstName`]}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.lastName`] ? 'border-red-500' : 'border-gray-300'
                }`}
                placeholder="Last name"
              />
              {errors[`clients.${index}.lastName`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.lastName`]}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.dateOfBirth`] ? 'border-red-500' : 'border-gray-300'
                }`}
              />
              {errors[`clients.${index}.dateOfBirth`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.dateOfBirth`]}</p>
              )}
            </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                errors[`clients.${index}.streetAddress`] ? 'border-red-500' : 'border-gray-300'
              } ${client.usesPrimaryAddress ? 'bg-gray-100 text-gray-500' : ''}`}
              placeholder="Street address"
            />
            {errors[`clients.${index}.streetAddress`] && (
              <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.streetAddress`]}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                disabled={client.usesPrimaryAddress}
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.city`] ? 'border-red-500' : 'border-gray-300'
                } ${client.usesPrimaryAddress ? 'bg-gray-100 text-gray-500' : ''}`}
                placeholder="City"
              />
              {errors[`clients.${index}.city`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.city`]}</p>
              )}
            </div>
            ...
            <div>
              ...
              <select
                ...
                disabled={client.usesPrimaryAddress}
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.state`] ? 'border-red-500' : 'border-gray-300'
                } ${client.usesPrimaryAddress ? 'bg-gray-100 text-gray-500' : ''}`}
              >
              ...
              {errors[`clients.${index}.state`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.state`]}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                disabled={client.usesPrimaryAddress}
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.zipCode`] ? 'border-red-500' : 'border-gray-300'
                } ${client.usesPrimaryAddress ? 'bg-gray-100 text-gray-500' : ''}`}
                placeholder="ZIP code"
              />
              {errors[`clients.${index}.zipCode`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.zipCode`]}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors[`clients.${index}.primaryPhone`] ? 'border-red-500' : 'border-gray-300'
                } ${client.usesPrimaryPhone ? 'bg-gray-100 text-gray-500' : ''}`}
                placeholder="(555) 123-4567"
              />
              {errors[`clients.${index}.primaryPhone`] && (
                <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.primaryPhone`]}</p>
              )}
            </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                errors[`clients.${index}.email`] ? 'border-red-500' : 'border-gray-300'
              }`}
              placeholder="email@example.com"
            />
            {errors[`clients.${index}.email`] && (
              <p className="mt-1 text-sm text-red-600">{errors[`clients.${index}.email`]}</p>
            )}
          </div>
